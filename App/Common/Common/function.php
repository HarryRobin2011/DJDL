 ...
 * @param $userId 用户ID
 * @param $desc   用户描述
 * @param $type   类型:类型: 4开地,5增种苗苗 6增种水稻 7收取秧苗 8收取苗苗 9升级稻草人 10 收割机放苗 11 出苗 12 收割机出水稻    13激活用户 14 转账 15确认收款  16打扫 17提现 18抽奖
 */
 ...
 * @param $userId 用户ID
 * @param $desc   用户描述
 * @param $type   类型:类型:1购买牲畜,2购买饲料,3购买激活码,4开地, 7收取秧苗 8收取苗苗 9升级稻草人 10 收割机放苗 11 出苗 12 收割机出水稻 //5绿地增种。6，增种， 取消掉换别的日志
 */
//新日志。记录用户所有交易记录
function addUserLog($userId,$desc,$type,$money){
    $id = M('user_finance')->add(array(
        'userid'        => $userId,
        'desc'          => $desc,
        'create_time'   => time(),
