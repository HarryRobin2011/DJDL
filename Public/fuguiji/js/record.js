...
//			$.ajax({
//				url: host + "/User/getUserFarmCount",
//				type: "post",
...
//					} else {
//						var cnt=parseInt(data.result[0].farmcount);
//						if(cnt<15){
//							console.log("仅能售卖鸡蛋");
//						}else{
//							console.log("可以售卖母鸡");
...
$('.deal-content .sale_egg,.deal-content .sale_chicken').delegate('#confirm2', 'click', function() {
	...
	if(!sale_num || !targetAccount || !targetNickname || !target_paypwd) {
...
$('#confirm1').click(function() {
	var recommend_account = $("#account").val(),
	// $('.deal-content .resgiNewUser .recommend_account').val(),
...
//		alipay = $('.deal-content .resgiNewUser .zhifubao').val();
	...
	if(!registerAccount || !realname || !phoneNum) {
