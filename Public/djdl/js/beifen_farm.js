	...
	$('.fieldBox .field li').click(function() {
		...
		if($(me).find('.chicken-box').length && !$(me).hasClass('canOpen')) {
			...
			var showboxHtml = '<div class="clickShowBox show" style="top: 0px;"><p><b>小鹅总数:</b><em>' +
				...
				'</em></p><p><b>本日产苗:</b><em>' +
				currentField.egg_rate + '</em></p><p><b>历史产苗:</b><em>' +
...
//					var me = this;
					$(res).each(function() {
						...
						var html = '<li style="height: 5.555556rem;"><div class="userBox" style="background-image: url(../../Public/djdl/images/home/portrait/portrait-man.png);top:29%"></div><div class="info" style="height: 50%;"><span class="name">'
